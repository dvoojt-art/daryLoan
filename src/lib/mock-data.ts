...
export const MOCK_MEMBERS: Member[] = [
  { id: 'm1', name: 'Member User', email: 'sinking@daryloan.com', role: 'member', totalContributions: 5000, joinDate: '2023-01-15', status: 'active', shares: 1200, profit: 450.50 },
...
export const MOCK_LOANS: Loan[] = [
  { id: 'l1', memberId: 'm1', loanerName: 'Member User', amount: 2000, status: 'approved', requestDate: '2024-02-10', dueDate: '2024-04-10', interestRate: 0.10, termMonths: 12, purpose: 'Home Repair' },
